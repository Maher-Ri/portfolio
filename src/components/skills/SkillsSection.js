  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        icon: <FaPhp />,
        name: "PHP",
        desc: "Dynamic scripting",
        level: "Basic",
      },
      {
        icon: <SiWordpress />,
        name: "CMS",
        desc: "WordPress basics",
        level: "Intermediate",
      },
    ],
  },
  ...
  //   },
  {
    ...
    skills: [
      ...
      },
      {
        icon: <FaCode />,
        name: "VS Code",
        desc: "IDE & productivity",
        level: "Expert",
      },
      {
        icon: <FaEnvelope />,
        name: "Email Testing",
        desc: "Litmus & Mailchimp",
        level: "Intermediate",
      },
    ],
  },
...
const SkillsSection = () => {
  ...
  return (
    <section className={classes.demo} ref={sectionRef} id="skills">
      <Container>
          ...
          <div key={i} className={classes.category}>
            ...
            <div className={classes.skillGrid}>
              {cat.skills.map((skill, index) => (
                <div
                  key={index}
                  className={`${classes.skillCard} ${classes.hidden}`}
                >
